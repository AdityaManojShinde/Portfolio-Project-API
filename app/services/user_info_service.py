...
class UserInfoService:
    ...
    @staticmethod
    def create_or_update_user_info(db: Session, user_id: str, info_data: UserInfoCreate) -> UserInfoDB:
    ...
    @staticmethod
    def update_user_info(db: Session, user_id: str, update_data: UserInfoUpdate) -> UserInfoDB:
        """Update user info."""
        try:
            user_info = db.query(UserInfoDB).filter(UserInfoDB.user_id == user_id).first()
            if not user_info:
