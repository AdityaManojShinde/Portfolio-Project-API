...
def get_user_projects(db: DatabaseSession, current_user: Annotated[User, Depends(get_current_user)]):
    """Retrieve all projects for the current user. Requires authentication."""
