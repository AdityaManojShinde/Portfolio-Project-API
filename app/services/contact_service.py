...
class ContactService:
    ...
    @staticmethod
    def create_or_update_contact(db: Session, user_id: str, contact_data: ContactCreate) -> ContactDB:
    ...
    @staticmethod
    def update_contact(db: Session, user_id: str, update_data: ContactUpdate) -> ContactDB:
        """Update contact info."""
        try:
            contact = db.query(ContactDB).filter(ContactDB.user_id == user_id).first()
            if not contact:
